                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-lg-10">
                                {!! Form::select('start_location',$location, null, ['class' => 'form-control', 'placeholder' => 'Select Here....']) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                {!! Form::select('end_location',$location,  null, ['class' => 'form-control', 'placeholder' => 'Select Here....']) !!}
                                <div class="error">{{ $errors->first('end_location') }}</div>
                            </div>
                        </div>
                        <?php $i = 1; $val = count($stoppages)?>
                        @foreach($stoppages as $stoppage)
                            <div class="form-group row {{$val == $i ? 'ss appendHere':''}}">
                                {!! Form::label('stoppage', 'Stoppage:', ['class' => 'col-lg-2 control-label']) !!}
                                <div class="col-lg-10">
                                    <div class="col-md-8 ">
                                        {!! Form::select('stoppage[]',$location, $stoppage->location_id, ['class' => 'form-control', 'placeholder' => 'Select Here....']) !!}
                                    </div>
                                    <div class="col-md-4">
